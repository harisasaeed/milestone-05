...
//             const shareLinkButton = document.createElement("button") as HTMLButtonElement;
...
(_a = document.getElementById("resumeForm")) === null || _a === void 0 ? void 0 : _a.addEventListener("submit", function (event) {
    ...
    if (profilePictureInput && nameElement && emailElement && phoneElement && educationElement && experienceElement && skillsElement && usernameElement) {
        ...
        // Generate unique path for saving the resume
        var uniquePath = "resumes/".concat(username_1.replace(/\s+/g, "__"), "_cv.html");
        // Picture element
            ...
            shareLinkButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            shareableLink = "https://yourdomain.com/resumes/".concat(username_1.replace(/\s+/g, "__"), "_cv.html");
                            // Use Clipboard API to copy the shareable link
